...
public class VariableEx01 {
	...
	public static void main(String[] args) {
		...
		// 변수의 초기값은 숫자는 0, boolean 은 false, 문자열은 "",char형은 0으로 초기화합니다.
		order1 = 2;
		order2 = 1;
		order3 = 6;
		order4 = 1;
		...
		System.out.println("떡볶이는 " + order1 + "인분 주문 하여서 금액은 " + res1 + "원 입니다.");
		System.out.println("순대는 " + order2 + "인분 주문 하여서 금액은 " + res2 + "원 입니다.");
		System.out.println("오뎅는 " + order3 + "개 주문 하여서 금액은 " + res3 + "원 입니다.");
		System.out.println("김밥는 " + order4 + "인분 주문 하여서 금액은 " + res4 + "원 입니다.");
